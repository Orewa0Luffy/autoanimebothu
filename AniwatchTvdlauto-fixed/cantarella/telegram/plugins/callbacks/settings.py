...
from kurigram.types import InlineKeyboardMarkup
...
async def on_toggle_ongoing(client: Client, callback_query):
    ...
    source_display = {"animetsu": "🌐 ANIMETSU", "aniwatch": "📺 ANIWATCH", "subsplease": "📦 SUBSPLEASE"}.get(active_source, "🌐 ANIMETSU")
    ...
    _next = {"animetsu": "aniwatch", "aniwatch": "subsplease", "subsplease": "animetsu"}
    source_toggle_label = {"animetsu": "🔄 ꜱᴡɪᴛᴄʜ ᴛᴏ ᴀɴɪᴡᴀᴛᴄʜ", "aniwatch": "🔄 ꜱᴡɪᴛᴄʜ ᴛᴏ ꜱᴜʙꜱᴘʟᴇᴀꜱᴇ", "subsplease": "🔄 ꜱᴡɪᴛᴄʜ ᴛᴏ ᴀɴɪᴍᴇᴛꜱᴜ"}.get(active_source, "🔄 ꜱᴡɪᴛᴄʜ ꜱᴏᴜʀᴄᴇ")
...
async def on_toggle_active_source(client: Client, callback_query):
    ...
    _cycle = {"animetsu": "aniwatch", "aniwatch": "subsplease", "subsplease": "animetsu"}
    new_source = _cycle.get(current_source, "animetsu")
    ...
    source_display = {"animetsu": "🌐 ANIMETSU", "aniwatch": "📺 ANIWATCH", "subsplease": "📦 SUBSPLEASE"}.get(new_source, "🌐 ANIMETSU")
    _next2 = {"animetsu": "aniwatch", "aniwatch": "subsplease", "subsplease": "animetsu"}
    source_toggle_label = {"animetsu": "🔄 ꜱᴡɪᴛᴄʜ ᴛᴏ ᴀɴɪᴡᴀᴛᴄʜ", "aniwatch": "🔄 ꜱᴡɪᴛᴄʜ ᴛᴏ ꜱᴜʙꜱᴘʟᴇᴀꜱᴇ", "subsplease": "🔄 ꜱᴡɪᴛᴄʜ ᴛᴏ ᴀɴɪᴍᴇᴛꜱᴜ"}.get(new_source, "🔄 ꜱᴡɪᴛᴄʜ ꜱᴏᴜʀᴄᴇ")
